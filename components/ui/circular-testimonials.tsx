        ...
        <div className="flex flex-col justify-between min-h-[18rem]">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.p className="leading-relaxed" style={{ color: colorTestimony, fontSize: fsQuote }}>
              ...
              {item.impact && (
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="w-1.5 h-1.5 rounded-full shrink-0" style={{ backgroundColor: item.color ?? colorDesig }} />
                  <span className="font-mono text-[11px] leading-snug" style={{ color: colorName, opacity: 0.65 }}>
                    {item.impact}
                  </span>
                </div>
              )}
          ...
          <div className="flex gap-4 mt-8">
            <button
              type="button"
              onClick={prev}
              className="w-11 h-11 rounded-full flex items-center justify-center cursor-pointer transition-colors duration-300 border-0 outline-none"
