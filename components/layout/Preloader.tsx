      ...
      {visible && (
        ...
        >
          ...
          <div ref={nameRef} className="mb-14 text-center opacity-0">
            <div className="font-impact text-[clamp(4rem,12vw,10rem)] leading-none" style={{ color: "#EDE8DC", letterSpacing: "-0.01em" }}>
              IMANE
            </div>
            <div className="font-impact text-[clamp(4rem,12vw,10rem)] leading-none -mt-2" style={{ color: "#7FCFE0", letterSpacing: "-0.01em" }}>
              MOUMOUN
            </div>
          </div>
          <div className="w-48 h-px bg-[rgba(255,255,255,0.06)] overflow-hidden relative mb-4">
            <div
              ...
              style={{ background: "linear-gradient(90deg, #7FCFE0, #8484C8)", transform: "scaleX(0)", transition: "none" }}
            />
          </div>
          <span ref={counterRef} className="font-mono text-xs text-[#3D3F52] tracking-widest">000</span>
